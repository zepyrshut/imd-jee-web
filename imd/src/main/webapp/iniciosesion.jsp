...
<html lang="es">
    ...
    <body>
        ...
        <section class="uk-align-center uk-text-center padding-top-medium">
        ...
        <main>
            ...
            <section class="uk-text-center uk-padding-small">
                <form method="POST" action="iniciosesion">
                    <section class="uk-form-controls uk-padding-small">
                        <span class="uk-inline">
                            ...
                            <input class="uk-input uk-form-width-large" id="usuario-login" onclick="cambioNeutral()"  type ="text" placeholder="Usuario" name="usuario" required />
                        </span>
                    </section>
                    <section class="uk-form-controls  uk-padding-small">
                        <span class="uk-inline">
                            ...
                            <input class="uk-input uk-form-width-large" id="contrasena-login" onclick="cambioNeutral()" type ="password" placeholder="Contraseña" name="contrasena" required />
                        </span>
                    </section>
                ...
                <c:if test="${datoIncorrecto != null}">
                    <section class="uk-alert-danger  uk-text-left"  id="mensajeError"  uk-alert>
                        <a class="uk-alert-close" uk-close>
                        </a>
                        <p>
                            <c:out value="${datoIncorrecto}"/>
                        </p>
                    </section>                
                </c:if>
            </section>
