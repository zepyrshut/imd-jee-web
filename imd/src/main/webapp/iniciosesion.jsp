    ...
    <body>
        ...
        <main>
            ...
            <div class="uk-container uk-container-small  uk-padding">
                ...
                <form class="uk-grid-small" uk-grid method="GET" action="iniciosesion">
                    ...
                    <div  class="uk-width-1-1">
                        ...
                        <div class="uk-form-controls">
                            <input class="uk-input" id="form-stacked-text" type="text"  name="usuario" required>
                        </div>
                    </div>
                    <div  class="uk-width-1-1">
                        <label class="uk-form-label" for="form-stacked-text">Contraseña:</label>
                        <div class="uk-form-controls">
                            <input class="uk-input" id="form-stacked-text"  type="password"  name="contrasena"required >
                        </div>
                    </div>
